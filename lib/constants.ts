...
/** Curated Unsplash assets (hero: friendly-plumber style, under-sink service) */
export const IMAGES = {
  heroTeam:
    "https://images.unsplash.com/photo-1676210134188-4c05dd172f89?auto=format&fit=crop&w=1200&q=80",
};
